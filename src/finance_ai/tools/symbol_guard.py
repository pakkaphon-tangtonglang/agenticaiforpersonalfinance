...
_NOT_FOUND_TEMPLATE = (
    "ไม่พบสัญลักษณ์ '{query}' ในระบบ "
    + "กรุณาตรวจสอบตัวย่อหุ้นแล้วลองใหม่อีกครั้ง หรือค้นหาชื่อสินทรัพย์ก่อน"
)

_AMBIGUOUS_TEMPLATE = (
    "สัญลักษณ์ '{query}' ไม่ชัดเจน พบหลายรายการที่คล้ายกัน "
    + "กรุณาระบุสัญลักษณ์ให้เฉพาะเจาะจงมากขึ้น"
)
